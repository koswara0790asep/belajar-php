              ...
              <div class="card mb-3">
                ...
                ?>
                  ...
                  <form class="row g-3 needs-validation" method="POST" novalidate>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name="login" id="login">Login</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Don't have?<a href="#" class="btn btn-sm btn-outline-secondary">🔒 Create an account</a></p>
                    </div>
                  </form>
